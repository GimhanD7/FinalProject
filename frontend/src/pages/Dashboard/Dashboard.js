        ...
        <div className='flex'>
            ...
            <ul>
                ...
                <li>
                            ...
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md  ${!open && "hidden"} `} to = "/home"><h3>Courses</h3></Link>
