...
export default function FeedbackListStudent() {
 ...
 {/* email, firstName, lastName,NIC,userName,address,dob mobile                              */}
            <th className="p-2 border-black tbhead "><h3>Email</h3></th>
            
                                            <th className="p-2 tbhead"><h3>FirstName</h3></th>
                                            <th className="p-2 tbhead"><h3>LastName</h3></th>
                                            <th className="p-2 tbhead"><h3>NIC</h3></th>
                                            <th className="p-2 tbhead"><h3>User Name</h3></th>
                                            <th className="p-2 tbhead"><h3>Address</h3></th>
                                            {/* <th className="p-2 tbhead">dob</th> */}
                                            
                                            <th className="p-2 tbhead"><h3>Mobile</h3></th>
                                            
                                            <th className="p-2 text-center tbhead"><h3>Update</h3></th>
